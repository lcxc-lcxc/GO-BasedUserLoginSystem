...
type UploadClient interface {
	Picture(ctx context.Context, in *PictureRequest, opts ...grpc.CallOption) (*PictureReply, error)
}
...
func (c *uploadClient) Picture(ctx context.Context, in *PictureRequest, opts ...grpc.CallOption) (*PictureReply, error) {
	out := new(PictureReply)
	err := c.cc.Invoke(ctx, "/Upload/Picture", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UploadServer interface {
	Picture(context.Context, *PictureRequest) (*PictureReply, error)
...
func (UnimplementedUploadServer) Picture(context.Context, *PictureRequest) (*PictureReply, error) {
...
func _Upload_Picture_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PictureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UploadServer).Picture(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Upload/Picture",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadServer).Picture(ctx, req.(*PictureRequest))
	}
...
var Upload_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Picture",
			Handler:    _Upload_Picture_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internel/proto/upload.proto",
}
